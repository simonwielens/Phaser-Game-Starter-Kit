...
export default class Multiplayer extends Phaser.Scene {
	...
	preload() {
		...
		this.load.spritesheet('dude1', 'assets/ida1.png', { frameWidth: 32, frameHeight: 48 });
		this.load.spritesheet('dude2', 'assets/Ida-black.png', { frameWidth: 32, frameHeight: 48 });
	...
	create() {
		...
		scoreText2 = this.add.text(416, 16, 'score: 0', { fontSize: '32px', fill: '#000' });
